...
INSERT INTO DUMMY_TABLE (T_INTEGER, T_VARCHAR200, T_BLOB) VALUES (0,'','');
...
INSERT INTO accounts (id, login, passwd, team_name, srole) VALUES (GEN_ID(key_seq, 1), 'anonymous', 'anonymous', 'anonymous', 0);

-- наши суперпользователи ;)
INSERT INTO accounts (id, login, passwd, team_name, srole) VALUES (GEN_ID(key_seq, 1), 'ask', '', 'ask', 0);
